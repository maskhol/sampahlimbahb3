...
<div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?= base_url; ?>/limbahmasuk/simpanLimbahmasuk" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label >Jumlah Limbah Masuk</label>
                    <input type="text" class="form-control" placeholder="Masukan Jumlah Limbah..." name="jml_limbah_masuk">
                  </div>
                  <div class="form-group">
