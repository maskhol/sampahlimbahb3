  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Halaman Edit Data Limbah</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
...
<div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?= base_url; ?>/limbahmasuk/updateLimbahmasuk" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="tgl_masuk" value="<?= $data['limbah_b3']['tgl_masuk'];?>">
                  </div>
                  <div class="form-group">
                    <label >Area</label>
                  ...
                  <div class="form-group">
                    <label >Jumbah Limbah Masuk</label>
                    <input type="text" class="form-control" placeholder="masukkan jumlah limbah masuk..." name="jml_limbah_masuk" value="<?= $data['limbah_b3']['jml_limbah_masuk'];?>">
                  </div>
                  <div class="form-group">
